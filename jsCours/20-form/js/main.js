function verif(form) {
    ...
    // let nom = document.querySelector("[name='nom']") // entre [] pour bien dire qu'on prend un attribut
...
// let compteur = document.querySelector(".info");
// let champMessage = document.querySelector("textarea");

// champMessage.onkeyup = function (e) {
//     let longueur = champMessage.value.length;
//     let reste = 10 - longueur;
//     compteur.innerHTML = `${reste} caractères restants`;
// }
