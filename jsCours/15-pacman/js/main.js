/*
let moove = document.querySelector('#pacman')
let x = 0;
let y = 0
...
window.onkeyup = function (e) {
    ...
    if (e.key == 'ArrowUp') {
        ...
        x -= 100;
        moove.style.top = x + "px";
    } else if (e.key == 'ArrowRight') {
        document.body.style.background = 'green';
        y += 100;
        moove.style.left = y + "px";
        moove.style.transform = 'rotateY(360deg)'
        ...
        y -= 100;
        moove.style.left = y + "px";
        moove.style.transform = 'rotateY(180deg)'
