...
let images = [
    { chemin: "img/animal1.jpg", nom: "animal1", prix: 200, type: "animaux" },
    { chemin: "img/animal2.jpg", nom: "animal2", prix: 200, type: "animaux" },
    { chemin: "img/animal3.jpg", nom: "animal3", prix: 200, type: "animaux" },
...
function genererImage(chemin, type) {
    ...
    newImg.className = "spaceElement " + type;
